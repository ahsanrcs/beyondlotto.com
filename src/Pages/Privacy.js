...
const Privacy = () => {
	return (
		<div className='text-dark bg-white'>
			...
			<p>
				Beyond Security &amp; LED Lighting built the Beyond Lotto app as a Free app. This SERVICE is provided by Beyond
				Security &amp; LED Lighting at no cost and is intended for use as is.
			</p>
			<p>
			...
			<p>
				...
				accessible at Beyond Lotto unless otherwise defined in this Privacy Policy.
			</p>
			<p>
			...
			<p>
				...
				identifiable information, including but not limited to Name, Email, Phone, Address. The information that I
			...
			<p>This policy is effective as of 2022-04-27</p>
			<p>
				<strong>Contact Us</strong>
			</p>
			<p>
				If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at
				support@beyondlotto.com.
			</p>
		</div>
	);
};
